...
console.log("умножить item_3 и item_4 =", item_3 * item_4)
...
console.log(typeof("item_6", item_6))
console.log(typeof("item_6_type ==", item_6))
console.log(typeof("item_6_type --", item_6))

/*Создать переменную item_7 и в ней преобразовать item_6 в String*/
let item_7 = String(item_6); //ПРЕОБРАЗОВАТЬ item_6???
...
console.log(typeof("item_7,", item_7))
console.log(typeof("item_7_type ==", item_7))
console.log(typeof("item_7_type --", item_7))
